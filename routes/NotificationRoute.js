...
router.post( "/postnot",authenticateUser,authorizeRole(["teacher", "principal"]),NotificationController.createNotification);
...
router.delete("/:id",authenticateUser,authorizeRole(["teacher", "principal"]),NotificationController.deleteNotification);
